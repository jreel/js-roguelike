 ...
 ********    * ***  *   **    ***     ***  *    ***     **** **** *
 ...
 (   ). '.  |  | ___ | /  | | | | | | | | | | |  ' _.'| |       |  ' _.'| |  | |
  | |  `\ | |  '(   ); |  ; | | ' | | | ' | | |  .'.-.| |       |  .'.-.| '  | |
  ; '._,' ' '  `-' | ' `-'  | ' `-' ; ' `-' ; '  `-' /| |       '  `-' /' `-'  /
   '.___.'   `.__,'  `.__.'_.  `.__.   `.__.   `.__.'(___)       `.__.'  `.__,'
  ___
 (   )
  | |_      .--.  ___  ___  ___  .--.  ___ .-.
 (   __)   /    \(   )(   )(   )/    \(   )   \
                ...
                `▀▀███▀"   "▀████▀▀"    `▀██▀"`"▀███▀▀"   '████▄.,▄▌  ▀▀████▀"
                   '▀"       '▀"         `▀     `▀         "██████▀      "▀"
                                                             "▀▀'
                                                                       ...
                                                                       `MM
                             /      /                                   MM         /
   ____     ____      ___   /M     /M      ____  ___  __   ____     ____MM        /M      _____  ____    _    ___  ____  ___  __
  6MMMMb\  6MMMMb.  6MMMMb /MMMMM /MMMMM  6MMMMb `MM 6MM  6MMMMb   6MMMMMM       /MMMMM  6MMMMMb `MM(   ,M.   )M' 6MMMMb `MM 6MM
 MM'    ` 6M'   Mb 8M'  `Mb MM     MM    6M'  `Mb MM69 " 6M'  `Mb 6M'  `MM        MM    6M'   `Mb `Mb   dMb   d' 6M'  `Mb MM69 "
 YM.      MM    `'     ,oMM MM     MM    MM    MM MM'    MM    MM MM    MM        MM    MM     MM  YM. ,PYM. ,P  MM    MM MM'
  YMMMMb  MM       ,6MM9'MM MM     MM    MMMMMMMM MM     MMMMMMMM MM    MM        MM    MM     MM  `Mb d'`Mb d'  MMMMMMMM MM
      `Mb MM       MM'   MM MM     MM    MM       MM     MM       MM    MM        MM    MM     MM   YM,P  YM,P   MM       MM
 L    ,MM YM.   d9 MM.  ,MM YM.  , YM.  ,YM    d9 MM     YM    d9 YM.  ,MM        YM.  ,YM.   ,M9   `MM'  `MM'   YM    d9 MM
 MYMMMM9   YMMMM9  `YMMM9'Yb.YMMM9  YMMM9 YMMMM9 _MM_     YMMMM9   YMMMMMM_        YMMM9 YMMMMM9     YP    YP     YMMMM9 _MM_
